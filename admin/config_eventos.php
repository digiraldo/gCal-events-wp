...
<body>
  ...
  <div class="container text-center text-white bg-dark" style=" height: 100%; width: 100%;">
    ...
    <div class="container text-center card text-white bg-dark mb-3" style="width: 100%;">
      ...
      <div class="card-footer text-muted">
        Mas información en: <img src="/wordpress/wp-content/plugins/google-calendar-events-wp/admin/img/DiGiraldo-18px.png" alt="image desc" /> <a href="https://digiraldo.online" target="_blank">DiGiraldo</a>
      </div>
    </div>
  </div>
